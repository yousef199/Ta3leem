...
public class ClassesSpinnerAdapter extends ArrayAdapter<DropDownListObject> {
    private Context mContext;
    private ArrayList<DropDownListObject> listState;
    private ClassesSpinnerAdapter subjectsSpinnerAdapter;
    private boolean isFromView = false;

    public ClassesSpinnerAdapter(Context context, int resource, List<DropDownListObject> objects) {
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(listState.get(position).isSelected()){
                    SharedPreferences sharedPreferences = mContext.getSharedPreferences(Constants.CLASSES_PREF,Context.MODE_PRIVATE );
